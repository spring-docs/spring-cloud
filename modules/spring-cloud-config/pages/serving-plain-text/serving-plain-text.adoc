...
* xref:serving-plain-text:spring-cloud-config-serving-plain-text-git-svn-native-backends.adoc#spring-cloud-config-serving-plain-text-git-svn-native-backends[spring-cloud-config-serving-plain-text-git-svn-native-backends]
* xref:serving-plain-text:spring-cloud-config-serving-plain-text-aws-s3.adoc#spring-cloud-config-serving-plain-text-aws-s3[spring-cloud-config-serving-plain-text-aws-s3]
